...
public interface ScoringModelService {
     ...
     */
    Mono<ScoringModelDTO> getById(Long scoringModelId);
     ...
     */
    Mono<ScoringModelDTO> update(Long scoringModelId, ScoringModelDTO dto);
     ...
     */
    Mono<Void> delete(Long scoringModelId);
}
